    ...
    $.supersized = function (options) {
        ...
        base._start = function () {
            ...
            if (base.options.slides.length > 1) {
                if (base.options.slides.length > 2) {
                    ...
                    var imgPrev = $('<img alt="' + base.options.slides[loadPrev].altSeo + '" src="' + base.options.slides[loadPrev].image + '"/>');
            ...
            /*x2 altSeo */
            //if (api.getField('altSeo') !== '') {
            if (api.getField('altSeo') !== '') {
                //img.attr('alt', api.getField('altSeo'));
                img.attr('alt', api.getField('altSeo'));
            }
            /*x2 altSeo */
            ...
            if (base.options.slides.length > 1) {
                ...
                var imgNext = $('<img alt="' + base.options.slides[loadNext].altSeo + '" src="' + base.options.slides[loadNext].image + '"/>');
        ...
        base.nextSlide = function () {
            ...
            if (!$(targetList).html()) {
                ...
                /*x2 altSeo */
                //if ( api.getField('altSeo') !== '' ) {
                if ( base.options.slides[loadSlide].altSeo !== '' ) {         
                //img.attr('alt', api.getField('altSeo'));
                img.attr('alt', base.options.slides[loadSlide].altSeo);
                }
                /*x2 altSeo */
