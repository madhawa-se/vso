...
if (!function_exists('of_options'))
{
	function of_options()
	{
		...
		$of_pages_tmp 		= array_unshift($of_pages, "Select a page:");
                ...
                //Backgorunds
		$of_backgrounds 			= array();
		$of_backgrounds_obj 		= get_pages(array('post_type'=>'background'));    
		foreach ($of_backgrounds_obj as $of_background) {
		    $of_backgrounds[$of_background->ID] = $of_background->post_name; }
		$of_backgrounds_tmp 		= array_unshift($of_backgrounds, "Select a background:");
                ...
                $args_slides = array(
                    ...
                    'meta_query' => array( 
                        array(
                            ...
                            'value' => array('tpl-homepage-slide-booking.php','tpl-homepage-slide-promos.php')
                        )
                    )
                );
...
$of_options[] = array( 	"name" 		=> "Homepage Layout Manager",
						...
						"id" 		=> "homepage_slides",
						"std" 		=> $homepage_slides_obj,
						"type" 		=> "sorter"
				);

/*
$of_options[] = array( 	"name" 		=> "Backgrounds",
						"desc" 		=> "Unlimited backgrounds with drag and drop sortings.",
						"id" 		=> "x2_homepage_backgrounds",
						"std" 		=> "",
						"type" 		=> "slider"
				);*/

/*
$of_options[] = array( 	"name" 		=> "Select a Background group",
						"desc" 		=> "A list of all the available grous of backgrounds",
						"id" 		=> "x2_homepage_backgrounds",
						"std" 		=> "Select a group of backgrounds:",
						"type" 		=> "select",
						"options" 	=> $of_backgrounds
				);
*/

$of_options[] = array( 	"name" 		=> "Options",
						"type" 		=> "heading"
                                 );

$of_options[] = array( 	"name" 		=> "Mobile Booking banner",
                                        "desc" 		=> "Text 1",
                                        "id" 		=> "x2_mobile_bookingbanner_text1",
                                        "std" 		=> "",
                                        "type" 		=> "text"
                        );
$of_options[] = array( 	"name" 		=> "",
                                        "desc" 		=> "Text 2",
                                        "id" 		=> "x2_mobile_bookingbanner_text2",
                                        "std" 		=> "",
                                        "type" 		=> "text"
                        );
...
$of_options[] = array( 	"name" 		=> "Google Map Cordinates",
						"desc" 		=> "ex 37.967503,23.746476",
						"id" 		=> "x2_contact_map_cord",
						"std" 		=> "",
						"type" 		=> "text"    
    );
...
$of_options[] = array( 	"name" 		=> "Pin Icon",
						"desc" 		=> "",
						"id" 		=> "x2_contact_pin",
...
$of_options[] = array( 	"name" 		=> "Pin Icon size ",
						"desc" 		=> "ex 144,87",
						"id" 		=> "x2_contact_pin_size",
						"std" 		=> "",
						"type" 		=> "text"    
    );

$of_options[] = array( 	"name" 		=> "Pin Icon (anchor point for the icon)",
						"desc" 		=> "ex 64,81",
						"id" 		=> "x2_contact_pin_anchor_point",
						"std" 		=> "",
						"type" 		=> "text"    
    );

$of_options[] = array( 	"name" 		=> "Booking Form",
						"type" 		=> "heading"
                                 );

$of_options[] = array( 	"name" 		=> "Booking System Url",
						"desc" 		=> "",
						"id" 		=> "x2_booking_url",
						"std" 		=> "",
						"type" 		=> "text"    
...
$of_options[] = array( 	"name" 		=> "Booking form text",
						"desc" 		=> "",
						"id" 		=> "x2_booking_form_text",
						"std" 		=> "",
						"type" 		=> "textarea"    
    );
...
$of_options[] = array( 	"name" 		=> "Footer Globals",
						"type" 		=> "heading"
                                 );
...
$of_options[] = array( 	"name" 		=> "Footer Copyright",
						"desc" 		=> "",
						"id" 		=> "x2_footer_copyright",
						"std" 		=> "",
						"type" 		=> "textarea"    
    );

$of_options[] = array( 	"name" 		=> "Footer Contact Info",
						"desc" 		=> "",
						"id" 		=> "x2_footer_contactinfo",
						"std" 		=> "",
						"type" 		=> "textarea"    
    );
