			...
			switch ( $value['type'] ) {
				...
				case 'select_google_font':
					...
					$output .= '<select class="select of-input google_font_select" name="'.$value['id'].'" id="'. $value['id'] .'">';
                                        ...
                                        foreach ($pp_font_arr as $select_key => $option) {
                                            //$selected
                                            $output .= '<option value="'.$option['css-name'].'" ' . selected($smof_data[$value['id']], $option['css-name'], false) . ' >'.$option['font-name'].'</option>';
					}
                                        /*
